...
const Footer = () => {
  return (
    <footer className="w-full bg-bg text-gray-300 px-6 py-5 mt-10 text-primary">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        {/* Contact Info */}
        <div>
          <h3 className="text-primary-dark font-semibold mb-3">Contact Info</h3>
          <ul className="space-y-2 text-sm">
            <li>123 Encounter Street, Lagos, Nigeria</li>
            <li>
              <a href="mailto:info@encountercity.org" className="hover:text-secondary-dark">
                info@encountercity.org
              </a>
            </li>
            <li>
              <a href="tel:+2348000000000" className="hover:text-secondary-dark">
                +234 800 000 0000
              </a>
            </li>
          </ul>
